...
export default function WeddingTuxedosCollection() {
  const { products, loading, error } = useShopifyProducts('tag:tux');
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-2xl font-semibold text-gray-900">Wedding Tuxedo Collection</h2>
          </div>
          <button
