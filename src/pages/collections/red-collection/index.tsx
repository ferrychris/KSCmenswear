...
export default function RedCollection() {
  const { products, loading, error } = useShopifyProducts('collection:"2025 Ultimate Red Collection for Men | Red Suits, Shoes, Accessories | KCT Menswear"');
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="absolute inset-0 flex flex-col justify-center px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            ...
            <p className="text-xl text-gray-200 max-w-2xl">
              Bold and striking styles in vibrant red
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="flex items-center justify-between mb-8">
          <h2 className="text-2xl font-semibold text-gray-900">Red Collection</h2>
          <button
