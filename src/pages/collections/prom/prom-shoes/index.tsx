...
import { ArrowLeft, Filter, Footprints } from 'lucide-react';
import { Link } from 'react-router-dom';
import { cn } from '@/lib/utils';

export default function PromShoesCollection() {
  const { products, loading, error } = useShopifyProducts('tag:ps');
        ...
        <div className="absolute inset-0 flex flex-col justify-center px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            ...
            <p className="text-xl text-gray-200 max-w-2xl">
              Complete your prom look with our elegant collection of formal footwear
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-2xl font-semibold text-gray-900">Prom Shoes Collection</h2>
          </div>
          <button
