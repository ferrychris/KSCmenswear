...
export default function SparklingVestsCollection() {
  const { products, loading, error } = useShopifyProducts('tag:sv');
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="relative h-[40vh] bg-gray-900">
        <img
          src="https://images.unsplash.com/photo-1598808503746-f34c53b9323e?auto=format&fit=crop&q=80"
          alt="Sparkling Vests"
        ...
        <div className="absolute inset-0 flex flex-col justify-center px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            ...
            <p className="text-xl text-gray-200 max-w-2xl">
              Add a touch of glamour with our stunning collection of sparkling vests
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-2xl font-semibold text-gray-900">Sparkling Vest Collection</h2>
          </div>
          <button
