...
import { ArrowLeft, Filter, Bot as Bow } from 'lucide-react';
import { Link } from 'react-router-dom';
import { cn } from '@/lib/utils';

export default function PromBowtiesCollection() {
  const { products, loading, error } = useShopifyProducts('tag:pbt');
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="relative h-[40vh] bg-gray-900">
        <img
          src="https://images.unsplash.com/photo-1624538000860-24e9d41a0741?auto=format&fit=crop&q=80"
          alt="Prom Bowties"
        ...
        <div className="absolute inset-0 flex flex-col justify-center px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            ...
            <p className="text-xl text-gray-200 max-w-2xl">
              Complete your prom look with our elegant collection of bowties
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-3">
            <Bow className="h-8 w-8 text-rose-600" />
            <h2 className="text-2xl font-semibold text-gray-900">Bowtie Collection</h2>
          </div>
          <button
