...
import { ArrowLeft, Filter, Crown } from 'lucide-react';
import { Link } from 'react-router-dom';
import { cn } from '@/lib/utils';

export default function PromTuxedoCollection() {
  const { products, loading, error } = useShopifyProducts('title:Prom AND title:Tuxedo');
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="relative h-[40vh] bg-gray-900">
        <img
          src="https://images.unsplash.com/photo-1555069519-127aadedf1ee?auto=format&fit=crop&q=80"
          alt="Prom Tuxedos"
        ...
        <div className="absolute inset-0 flex flex-col justify-center px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            ...
            <p className="text-xl text-gray-200 max-w-2xl">
              Make your prom night unforgettable with our exclusive collection of tuxedos
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-2xl font-semibold text-gray-900">Prom Tuxedo Collection</h2>
          </div>
          <button
