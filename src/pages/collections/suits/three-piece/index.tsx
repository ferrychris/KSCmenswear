...
export default function ThreePieceSuits() {
  const { products, loading, error } = useShopifyProducts('tag:three-piece');
        ...
        <div className="absolute inset-0 flex flex-col justify-center px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            ...
            <p className="text-xl text-gray-200 max-w-2xl">
              The epitome of refined elegance with perfectly matched vests
            </p>
          </div>
        </div>
      </div>
