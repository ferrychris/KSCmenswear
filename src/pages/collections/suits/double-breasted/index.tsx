...
export default function DoubleBreasted() {
  const { products, loading, error } = useShopifyProducts('tag:double-breasted');
        ...
        <div className="absolute inset-0 flex flex-col justify-center px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            ...
            <p className="text-xl text-gray-200 max-w-2xl">
              Classic sophistication meets modern style in our collection of double-breasted suits
            </p>
          </div>
        </div>
      </div>
