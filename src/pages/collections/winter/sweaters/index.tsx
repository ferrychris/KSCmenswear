...
export default function WinterSweaters() {
  const { products, loading, error } = useShopifyProducts('tag:winter');
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="relative h-[40vh] bg-gray-900">
        <img
          src="https://images.unsplash.com/photo-1608991466857-5aaa2e7e593f?auto=format&fit=crop&q=80"
          alt="Winter Sweaters"
        ...
        <div className="absolute inset-0 flex flex-col justify-center px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            ...
            <p className="text-xl text-gray-200 max-w-2xl">
              Premium wool and cashmere sweaters for the cold season
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="flex items-center justify-between mb-8">
          <h2 className="text-2xl font-semibold text-gray-900">Sweater Collection</h2>
          <button
